...
final class RecordingObserver<T> implements Observer<T> {
  ...
  public T takeValue() {
    ...
    assertThat(notification.isOnNext())
        .named("Expected onNext event but was " + notification)
        .isTrue();
  ...
  public Throwable takeError() {
    ...
    assertThat(notification.isOnError())
        .named("Expected onError event but was " + notification)
        .isTrue();
  ...
  public void assertComplete() {
    ...
    assertThat(notification.isOnComplete())
        .named("Expected onCompleted event but was " + notification)
        .isTrue();
    assertNoEvents();
  }
